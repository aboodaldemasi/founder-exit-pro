...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Founder Exit collects, uses and protects information submitted by founders and buyers." },
...
const sections: { h: string; p: string }[] = [
  ...
  { h: "Your rights", p: "You may request access to, correction of, or deletion of your personal data at any time by writing to hello@founderexit.pro." },
  { h: "Contact", p: "Questions about this policy can be directed to hello@founderexit.pro." },
];
